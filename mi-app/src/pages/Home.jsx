  ...
  return (
    <section className="home">
      ...
      <div className="home__content">
        ...
        <p className="home__bio">
          Mi stack incluye <strong>HTML, CSS, JavaScript y React</strong> en el frontend, <strong>Python, Java y Django</strong> en el backend y como bases de datos <strong>Mysql, PostgreSQL y Supabase</strong>. Me apasiona seguir creciendo,
